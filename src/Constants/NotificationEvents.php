...
namespace AfterPay\Constants;

/**
 * Class NotificationEvents
 * @package AfterPay\Constants
 */
class NotificationEvents
{
    ...
    const PAYMENT_CAPTURE_REVERSED = 'PAYMENT.CAPTURE.REVERSED';	// AfterPay reverses a payment capture.
    ...
    const PAYMENT_SALE_REVERSED = 'PAYMENT.SALE.REVERSED';	    // AfterPay reverses a sale.
